...
const contactLinks = [
  {
    ...
    color: colors.green,
    label: 'EMAIL',
    display: 'forbes3559@gmail.com',
    href: 'mailto:forbes3559@gmail.com',
  },
  {
    icon: <LinkedinIcon />,
    iconBg: colors.blue,
    color: colors.blue,
    label: 'LINKEDIN',
    display: 'linkedin.com/in/stephen-forbes-smn3043559',
    href: 'https://www.linkedin.com/in/stephen-forbes-smn3043559',
  },
  {
    icon: <GithubIcon />,
    iconBg: colors.text,
    color: colors.bright,
    label: 'GITHUB',
    display: 'github.com/adidas3559',
    href: 'https://github.com/adidas3559',
  },
]
